...
<!-- >>> harness >>> -->
<!-- GENERATED by harness/apply.sh v1.3.1. Do not edit here. Edit the harness repo and run apply.sh again. -->

## Active Harness (v1.3.1)
...
- `security-discipline.md` — adversarial security review (triggered surfaces, two cadences)
...
- `/teach-me-back` → `.claude/skills/teach-me-back/SKILL.md` (post-study comprehension verification)
